...
cd .vitepress/dist # if you are deploying to a custom domain
...
git push -f git@github.com:RoadSideUniversity/roadsideuniversity.github.io.git master:gh-pages cd -